 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws1.servyou.gov/", wsdlLocation = "http://10.19.128.144:9408/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws1.servyou.gov/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.19.128.144:9408/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws1.servyou.gov/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws1.servyou.gov/", "HelloServicePort"), HelloService.class, features);
    }
